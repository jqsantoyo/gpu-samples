...
// Triangle Vulkan
//
// Sample that draws a triangle based on Vulkan's Tutorial, but simplified and flattened.
//
///////////////////////////////////////////////////////////////////////////////////////////////////
#define UNICODE
#define NOMINMAX
...
inline void exitError(const std::string& msg) {
    std::cerr << msg;
    exit(EXIT_FAILURE);
}
